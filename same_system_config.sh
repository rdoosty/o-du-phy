#!/bin/bash
# Create VFs
sudo echo 2 > /sys/class/net/p2p1/device/sriov_numvfs
sudo echo 2 > /sys/class/net/p2p2/device/sriov_numvfs
sudo echo 2 > /sys/bus/pci/devices/0000:25:00.0/sriov_numvfs
sudo ip link set p2p1 vf 1 mac 00:11:22:33:44:66 vlan 1
sudo ip link set p2p1 vf 0 mac 00:11:22:33:44:66 vlan 2
echo 2 > /sys/bus/pci/devices/0000:25:00.1/sriov_numvfs
sudo ip link set p2p2 vf 1 mac 00:11:22:33:44:55 vlan 1
sudo ip link set p2p2 vf 0 mac 00:11:22:33:44:55 vlan 2
